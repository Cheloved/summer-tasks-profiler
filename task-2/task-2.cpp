 ...
 *
 * Программа принимает аргументы командной строки — пути к файлам.
 * Вычисляет хэш файлов и выводит его в шестнадцатеричном виде.
 *
 * @param argc Количество аргументов командной строки.
 * @param argv Массив аргументов командной строки.
 *             Первый(и далее) аргументы должны быть путями к файлам.
 *
